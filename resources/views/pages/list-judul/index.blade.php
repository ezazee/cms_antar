...
<head>
        <meta charset="utf-8" />
         <title>List Judul Bantuan | Antar Bantuan Logistik</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">List Judul Bantuan</h4>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 24-11-2022 </td>
                                                           <td>
                                                                    <a class="btn btn-primary waves-effect btn-label waves-light btn-sm" href="{{ route('detail-judul') }}"><i class=" mdi mdi-tooltip-edit label-icon"></i> Detail</a>
